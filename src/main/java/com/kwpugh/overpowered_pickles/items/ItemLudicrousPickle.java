...
public class ItemLudicrousPickle extends Item
{

	public ItemLudicrousPickle(Properties properties)
	{
		super(properties);
	}
	...
	public ItemStack onItemUseFinish(ItemStack stack, World worldIn, LivingEntity entityLiving)
	{
		...
		PlayerSpecialAbilities.giveNewMaxHealth(worldIn, player, stack, 50.0F);
